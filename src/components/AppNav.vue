<template>
  <nav>
    <div class="navcontain">
      ...
      <span>Vue Directory Structure</span>

      <div class="icons">
        <a href="https://github.com/sdras/vue-directory-tree/" target="_blank">
          <svg class="github" role="presentation" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" aria-labelledby="github">
